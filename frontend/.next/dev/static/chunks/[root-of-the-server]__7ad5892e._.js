...
function Login() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/auth/login", {
                email,
                password
            });
            // token এবং userId localStorage-এ save করা
            localStorage.setItem("token", res.data.token);
            localStorage.setItem("userId", res.data.user._id);
            alert("Login successful!");
            router.push("/messages"); // লগইন সফল হলে messages পেজে নিয়ে যাবে
        } catch (err) {
            console.error(err);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ad5892e._.js.map