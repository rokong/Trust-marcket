...
function AdminMessages() {
    ...
    const loadUsers = async ()=>{
        try {
            const token = localStorage.getItem("token");
            if (!token) return;
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get("/admin/message-users", {
                headers: {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminMessages.useEffect": ()=>{
            ...
            const interval = setInterval({
                "AdminMessages.useEffect.interval": ()=>loadUsers()
            }["AdminMessages.useEffect.interval"], 3000);
            return ({
                "AdminMessages.useEffect": ()=>clearInterval(interval)
            })["AdminMessages.useEffect"];
        }
    }["AdminMessages.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminMessages.useEffect": ()=>{
            const handleVisibilityChange = {
                "AdminMessages.useEffect.handleVisibilityChange": ()=>{
            ...
            return ({
                "AdminMessages.useEffect": ()=>document.removeEventListener("visibilitychange", handleVisibilityChange)
            })["AdminMessages.useEffect"];
        }
    }["AdminMessages.useEffect"], []);
    ...
    const openChat = async (userId)=>{
        try {
            const token = localStorage.getItem("token");
            if (!token) return;
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`/admin/messages/mark-read/${userId}`, {}, {
                headers: {
                    Authorization: `Bearer ${token}`
                }
            });
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-gray-100 p-4 md:p-6 relative",
        children: [
            ...
            users.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: users.map((u)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            u.unreadCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "absolute top-2 md:top-3 right-2 md:right-3 bg-red-500 text-white w-5 h-5 md:w-6 md:h-6 flex items-center justify-center rounded-full text-xs md:text-sm font-bold",
                                children: u.unreadCount
                            }, void 0, false, {
                                fileName: "[project]/frontend/pages/admin/messages/index.js",
                                lineNumber: 109,
                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "w-10 h-10 md:w-12 md:h-12 bg-blue-100 flex justify-center items-center rounded-full text-lg md:text-xl",
                                        children: "👤"
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/pages/admin/messages/index.js",
                                        lineNumber: 115,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-2 md:mt-3 text-gray-600 text-xs md:text-sm",
                                children: [
                                    "⏱ Last Message:",
                                    " ",
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: formatTime(u.lastMessageTime)
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/pages/admin/messages/index.js",
                                        lineNumber: 128,
                                        columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-1 md:mt-2 text-blue-600 text-xs md:text-sm font-medium",
...
_s(AdminMessages, "SNq7IE6dDsY3ebTVOj5tNQWgBic=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a664785f._.js.map