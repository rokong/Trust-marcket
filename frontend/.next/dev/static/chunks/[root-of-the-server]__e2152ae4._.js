...
"[project]/frontend/pages/admin/index.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminHome.useEffect": ()=>{
            ...
            async function fetchStats() {
                try {
                    // pending posts
                    const pendingRes = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/admin/pending-posts');
                    const pendingCount = pendingRes.data?.length || 0;
                    // approved posts (use posts/approved)
                    const approvedRes = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/posts/index');
                    const approvedCount = approvedRes.data?.length || 0;
                    // transactions
                    const txRes = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('../transactions');
...
_s(AdminHome, "ZTaLYVEIbiu1JAK2pjelfCFNzN8=");
_c = AdminHome;
var _c;
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/index.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/admin";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/frontend/pages/admin/index.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/frontend/pages/admin/index.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/index.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__e2152ae4._.js.map