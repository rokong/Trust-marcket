...
"[project]/frontend/pages/admin/messages/[userId].js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ChatPage() {
    ...
    const [reply, setReply] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    /* ---------------- Load User Info ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            if (!userId) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/admin/message-user/${userId}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then({
                "ChatPage.useEffect": (res)=>setUser(res.data)
    ...
    /* ---------------- Load Messages ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            if (!userId) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/admin/messages/${userId}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then({
                "ChatPage.useEffect": (res)=>setMessages(res.data)
            }["ChatPage.useEffect"]).catch(console.error);
        }
    }["ChatPage.useEffect"], [
        userId
    ...
    /* ---------------- Send Reply ---------------- */ const sendReply = async ()=>{
        if (!reply.trim()) return;
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post("/admin/messages/send", {
                userId,
                text: reply,
                sender: "admin",
                type: "text"
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$arrow$2d$left$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ArrowLeft$3e$__["ArrowLeft"], {}, void 0, false, {
                            fileName: "[project]/frontend/pages/admin/messages/[userId].js",
                            lineNumber: 101,
                            columnNumber: 11
                        }, this)
                    }, void 0, false, {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        className: "font-bold",
                        children: user ? user.name || "User" : "Chat"
                    }, void 0, false, {
                        fileName: "[project]/frontend/pages/admin/messages/[userId].js",
                        lineNumber: 103,
                        columnNumber: 9
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    m.type === "shared_post" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        className: `px-3 py-2 rounded-xl ${m.sender === "admin" ? "bg-blue-600 text-white" : "bg-white shadow"}`,
                                        children: m.text
                                    }, void 0, false, {
                                        fileName: "[project]/frontend/pages/admin/messages/[userId].js",
                                        lineNumber: 128,
...
_s(ChatPage, "EeXveHEKrcDntWKWZAALyk+h27w=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/messages/[userId].js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/admin/messages/[userId]";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/frontend/pages/admin/messages/[userId].js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/frontend/pages/admin/messages/[userId].js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/admin/messages/[userId].js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__db5b7e47._.js.map