...
"[project]/frontend/pages/dashboard/account.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Account() {
    ...
    if (!user) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(Account, "C1U3W1/GLXpNOs2elmI/sE+Rt18=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/dashboard/account.js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/dashboard/account";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/frontend/pages/dashboard/account.js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/frontend/pages/dashboard/account.js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/dashboard/account.js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__3e491cdb._.js.map