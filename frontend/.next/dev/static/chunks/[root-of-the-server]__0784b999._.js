...
function Dashboard() {
    ...
    const loadStats = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get('/admin/stats');
            setStats(res.data);
        } catch (err) {
...
_s(Dashboard, "St5lAdfrwdgx4fpBxZpV16ONVvE=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0784b999._.js.map