...
"[project]/frontend/components/PaymentModal.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PaymentModal({ open, onClose, onPay, price }) {
    _s();
    const [method, setMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('bkash');
    const [tx, setTx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])('');
    if (!open) return null;
...
_s(PaymentModal, "GuEtbRInacteexdzYeKxRNbeHpQ=");
_c = PaymentModal;
var _c;
...
"[project]/frontend/pages/listing/[id].js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$PaymentModal$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/frontend/components/PaymentModal.js [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function ListingPage() {
    _s();
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { id } = r.query;
    ...
    const [openPay, setOpenPay] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ListingPage.useEffect": ()=>{
            if (!id) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/posts/${id}`).then({
                "ListingPage.useEffect": (r)=>setPost(r.data)
            }["ListingPage.useEffect"]).catch({
                "ListingPage.useEffect": (e)=>console.error(e)
            }["ListingPage.useEffect"]);
        }
    }["ListingPage.useEffect"], [
        id
    ...
    const handlePay = async ({ method, tx })=>{
        try {
            ...
            const orderRes = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post('/orders', {
                postId: id,
                paymentMethod: method
            });
            const orderId = orderRes.data.order.id || orderRes.data.orderId || orderRes.data.orderId;
            await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].post(`/payment/pay`, {
                postId: id,
                paymentMethod: method,
                transactionId: tx
            });
    ...
    if (!post) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$components$2f$PaymentModal$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                open: openPay,
...
_s(ListingPage, "AKT9raC5qM9DbaC//24g8bkBb14=", false, function() {
    return [
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/listing/[id].js [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/listing/[id]";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/frontend/pages/listing/[id].js [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/frontend/pages/listing/[id].js\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/frontend/pages/listing/[id].js [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__8b408ebb._.js.map