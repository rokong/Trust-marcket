...
function BuyPage() {
    ...
    const [paymentMethod, setPaymentMethod] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])("bkash");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BuyPage.useEffect": ()=>{
            if (!post) return;
            const loadPost = {
                "BuyPage.useEffect.loadPost": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].get(`/posts/${post}`);
                        setPostData(res.data);
                    } catch (err) {
                        console.error(err);
                    }
                }
            }["BuyPage.useEffect.loadPost"];
            loadPost();
        }
    }["BuyPage.useEffect"], [
        post
    ]);
    if (!postData) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        children: "Loading..."
    }, void 0, false, {
...
_s(BuyPage, "JGh84sLsw+KgZmlVyYmDLvqTpDc=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c9fdfc56._.js.map