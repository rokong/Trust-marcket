module.exports = [
"[project]/backend/node_modules/mongoose/lib/model.js [ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DocumentNotFoundError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/notFound.js [ssr] (ecmascript)");
...
const ObjectParameterError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/objectParameter.js [ssr] (ecmascript)");
const OverwriteModelError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/overwriteModel.js [ssr] (ecmascript)");
const Query = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/query.js [ssr] (ecmascript)");
const SaveOptions = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/options/saveOptions.js [ssr] (ecmascript)");
...
const VersionError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/version.js [ssr] (ecmascript)");
const ParallelSaveError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/parallelSave.js [ssr] (ecmascript)");
const applyDefaultsHelper = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/applyDefaults.js [ssr] (ecmascript)");
const applyDefaultsToPOJO = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/model/applyDefaultsToPOJO.js [ssr] (ecmascript)");
...
const applyMethods = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/model/applyMethods.js [ssr] (ecmascript)");
const applyProjection = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/projection/applyProjection.js [ssr] (ecmascript)");
const applyReadConcern = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/schema/applyReadConcern.js [ssr] (ecmascript)");
const applySchemaCollation = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/indexes/applySchemaCollation.js [ssr] (ecmascript)");
const applyStaticHooks = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/model/applyStaticHooks.js [ssr] (ecmascript)");
const applyStatics = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/model/applyStatics.js [ssr] (ecmascript)");
const applyTimestampsHelper = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/applyTimestamps.js [ssr] (ecmascript)");
const applyWriteConcern = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/schema/applyWriteConcern.js [ssr] (ecmascript)");
const applyVirtualsHelper = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/applyVirtuals.js [ssr] (ecmascript)");
const assignVals = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/populate/assignVals.js [ssr] (ecmascript)");
...
const createPopulateQueryFilter = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/populate/createPopulateQueryFilter.js [ssr] (ecmascript)");
...
const getModelsMapForPopulate = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/populate/getModelsMapForPopulate.js [ssr] (ecmascript)");
...
const isDefaultIdIndex = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/indexes/isDefaultIdIndex.js [ssr] (ecmascript)");
const isIndexEqual = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/indexes/isIndexEqual.js [ssr] (ecmascript)");
const isTimeseriesIndex = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/indexes/isTimeseriesIndex.js [ssr] (ecmascript)");
const { getRelatedDBIndexes, getRelatedSchemaIndexes } = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/indexes/getRelatedIndexes.js [ssr] (ecmascript)");
...
const parallelLimit = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/parallelLimit.js [ssr] (ecmascript)");
...
const pushNestedArrayPaths = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/model/pushNestedArrayPaths.js [ssr] (ecmascript)");
const removeDeselectedForeignField = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/populate/removeDeselectedForeignField.js [ssr] (ecmascript)");
...
const minimize = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/minimize.js [ssr] (ecmascript)");
const MongooseBulkSaveIncompleteError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/bulkSaveIncompleteError.js [ssr] (ecmascript)");
 ...
 */ Model.prototype.deleteOne = function deleteOne(options) {
    ...
    query.pre(async function queryPreDeleteOne() {
        await new Promise((resolve, reject)=>{
            self.constructor._middleware.execPre('deleteOne', self, [
                self
            ], (err)=>{
                if (err) reject(err);
                else resolve();
    ...
    query.pre(function callSubdocPreHooks(cb) {
        each(self.$getAllSubdocs(), (subdoc, cb)=>{
            subdoc.constructor._middleware.execPre('deleteOne', subdoc, [
                subdoc
            ], cb);
        }, cb);
    });
    ...
    query.post(function callSubdocPostHooks(cb) {
        each(self.$getAllSubdocs(), (subdoc, cb)=>{
            subdoc.constructor._middleware.execPost('deleteOne', subdoc, [
                subdoc
            ], {}, cb);
        }, cb);
    });
    query.post(function queryPostDeleteOne(cb) {
        self.constructor._middleware.execPost('deleteOne', self, [
            self
        ], {}, cb);
    });
    return query;
 ...
 */ function _checkContext(ctx, fnName) {
    ...
    if (ctx == null || ctx === /*TURBOPACK member replacement*/ __turbopack_context__.g) {
 ...
 */ Model.createCollection = async function createCollection(options) {
    ...
    const shouldSkip = await new Promise((resolve, reject)=>{
        this.hooks.execPre('createCollection', this, [
            options
        ], (err)=>{
            if (err != null) {
    ...
    try {
        ...
        if (err != null && (err.name !== 'MongoServerError' || err.code !== 48)) {
            await new Promise((resolve, reject)=>{
                ...
                this.hooks.execPost('createCollection', this, [
                    null
                ], _opts, (err)=>{
                    if (err != null) {
                        return reject(err);
 ...
 */ Model.bulkWrite = async function bulkWrite(ops, options) {
    ...
    options = options || {};
    const shouldSkip = await new Promise((resolve, reject)=>{
        this.hooks.execPre('bulkWrite', this, [
            ops,
            options
        ], (err)=>{
            if (err != null) {
    ...
    if (ordered) {
        ...
        try {
            ...
            await new Promise((resolve, reject)=>{
                ...
                this.hooks.execPost('bulkWrite', this, [
                    null
                ], _opts, (err)=>{
                    if (err != null) {
                        return reject(err);
        ...
        let error;
        [res, error] = await this.$__collection.bulkWrite(validOps, options).then((res)=>[
                res,
                null
            ]).catch((error)=>[
                null,
 ...
 */ Model.bulkSave = async function bulkSave(documents, options) {
    ...
    const { bulkWriteResult, bulkWriteError } = await this.bulkWrite(writeOperations, opts).then((res)=>({
            bulkWriteResult: res,
            bulkWriteError: null
        }), (err)=>({
...
function buildPreSavePromise(document, options) {
    return new Promise((resolve, reject)=>{
        document.schema.s.hooks.execPre('save', document, [
            options
        ], (err)=>{
            if (err) {
                reject(err);
...
function handleSuccessfulWrite(document) {
    return new Promise((resolve, reject)=>{
        ...
        document.$__reset();
        document.schema.s.hooks.execPost('save', document, [
            document
        ], {}, (err)=>{
            if (err) {
                reject(err);
 ...
 */ Model.hydrate = function(obj, projection, options) {
    ...
    const document = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/queryHelpers.js [ssr] (ecmascript)").createModel(this, obj, projection);
 ...
 */ Model.clientEncryption = function clientEncryption() {
    ...
    const { keyVaultNamespace, keyVaultClient, kmsProviders, credentialProviders, proxyOptions, tlsOptions } = autoEncryptionOptions;
...
//# sourceMappingURL=6d019_mongoose_lib_model_f76833ea.js.map