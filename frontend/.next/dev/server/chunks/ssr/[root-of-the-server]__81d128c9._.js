...
function Messages() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        socket.current = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io$2d$client__$5b$external$5d$__$28$socket$2e$io$2d$client$2c$__esm_import$29$__["io"])("http://localhost:5000"); // সার্ভারের URL
    ...
    const sendMessage = ()=>{
        if (!text.trim()) return;
        socket.current.emit("sendTextMessage", {
            userId,
            text,
            sender: "user"
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81d128c9._.js.map