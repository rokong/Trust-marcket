...
function Messages() {
    ...
    const sendMessage = async ()=>{
        if (!input) return;
        await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post("http://localhost:5000/api/messages/send", {
            userId,
            message: input
        });
        setInput("");
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("h2", {
            children: "User ID পাওয়া যায়নি! আগে Login করুন।"
        }, void 0, false, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d3e7e607._.js.map