...
"[project]/frontend/pages/admin/messages/[userId].js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function ChatPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!userId) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].connect();
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].emit("joinRoom", userId);
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].on("receiveMessage", (msg)=>{
            setMessages((prev)=>[
                    ...prev,
                    msg
                ]);
        ...
        return ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].off("receiveMessage");
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].disconnect();
        };
    }, [
        userId
    ]);
    /* ---------------- Load User Info ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!userId) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get(`/admin/message-user/${userId}`, {
            headers: {
    ...
    /* ---------------- Load Messages ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (!userId) return;
        __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get(`/admin/messages/${userId}`, {
            headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`
            }
    ...
    /* ---------------- Auto Scroll ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
    ...
    /* ---------------- Send Reply ---------------- */ const sendReply = async ()=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/admin/messages/send", {
                userId,
                text: reply,
                sender: "admin",
                type: "text"
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$socket$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].emit("sendMessage", res.data);
            setMessages((prev)=>[
                    ...prev,
                    res.data
                ]);
                ...
                children: [
                    messages.map((m)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                children: [
                                    m.type === "shared_post" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aed0924a._.js.map