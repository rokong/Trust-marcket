module.exports = [
"[project]/backend/node_modules/mongoose/lib/document.js [ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*!
 * Module dependencies.
 */ const DivergentArrayError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/divergentArray.js [ssr] (ecmascript)");
const EventEmitter = __turbopack_context__.r("[externals]/events [external] (events, cjs)").EventEmitter;
const InternalCache = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/internal.js [ssr] (ecmascript)");
...
const MixedSchema = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/schema/mixed.js [ssr] (ecmascript)");
const ModifiedPathsSnapshot = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/modifiedPathsSnapshot.js [ssr] (ecmascript)");
...
const ParallelValidateError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/parallelValidate.js [ssr] (ecmascript)");
...
const ValidatorError = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/error/validator.js [ssr] (ecmascript)");
const $__hasIncludedChildren = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/projection/hasIncludedChildren.js [ssr] (ecmascript)");
...
const compile = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/compile.js [ssr] (ecmascript)").compile;
...
const firstKey = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/firstKey.js [ssr] (ecmascript)");
const flatten = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/common.js [ssr] (ecmascript)").flatten;
const getEmbeddedDiscriminatorPath = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/getEmbeddedDiscriminatorPath.js [ssr] (ecmascript)");
const getKeysInSchemaOrder = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/schema/getKeysInSchemaOrder.js [ssr] (ecmascript)");
const getSubdocumentStrictValue = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/schema/getSubdocumentStrictValue.js [ssr] (ecmascript)");
...
const queryhelpers = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/queryHelpers.js [ssr] (ecmascript)");
...
const documentModifiedPaths = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/symbols.js [ssr] (ecmascript)").documentModifiedPaths;
...
const getDeepestSubdocumentForPath = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/document/getDeepestSubdocumentForPath.js [ssr] (ecmascript)");
        ...
        if (!schemaType && utils.isPOJO(value)) {
            ...
            if (value === null) {
                ...
                if (schemaType && !wasPopulated && !opts.hydratedPopulatedDocs) {
                    ...
                    doc[i] = schemaType.cast(value, self, true, undefined, {
 ...
 */ Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
    Embedded = Embedded || __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/types/arraySubdocument.js [ssr] (ecmascript)");
    ...
    if (shouldModify) {
        ...
        MongooseArray || (MongooseArray = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/types/array/index.js [ssr] (ecmascript)"));
 ...
 */ Document.prototype.get = function(path, type, options) {
    ...
    let obj = this._doc;
    const pieces = hasDot ? path.split('.') : [
        path
    ];
    // Might need to change path for top-level alias
    ...
    if (!isNestedValidate) {
        ...
        for (const subdoc of topLevelSubdocs){
            if (subdoc.$basePath) {
                ...
                !subdocParent.$__.activePaths.getStatePaths('modify').hasOwnProperty(fullPathToSubdoc) && !subdocParent.$isDefault(fullPathToSubdoc)) {
 ...
 */ Document.prototype.$__getArrayPathsToValidate = function() {
    DocumentArray || (DocumentArray = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/types/documentArray/index.js [ssr] (ecmascript)"));
...
//# sourceMappingURL=6d019_mongoose_lib_document_fa6c48e7.js.map