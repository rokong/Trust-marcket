...
"[project]/frontend/pages/dashboard/my-posts.js [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MyPosts() {
    ...
    const loadPosts = async ()=>{
        const token = localStorage.getItem("token");
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/posts/my-posts", {
            headers: {
    ...
    const handleDelete = async (id)=>{
        ...
        const token = localStorage.getItem("token");
        await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/posts/${id}`, {
            headers: {
                Authorization: `Bearer ${token}`
            }
        });
    ...
    if (posts.length === 0) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
        className: "p-6",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a29eee14._.js.map