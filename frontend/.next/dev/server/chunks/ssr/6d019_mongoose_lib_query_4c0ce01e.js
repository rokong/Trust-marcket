module.exports = [
"[project]/backend/node_modules/mongoose/lib/query.js [ssr] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const QueryCursor = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/cursor/queryCursor.js [ssr] (ecmascript)");
...
const castArrayFilters = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/update/castArrayFilters.js [ssr] (ecmascript)");
...
const isSubpath = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/projection/isSubpath.js [ssr] (ecmascript)");
const mpath = __turbopack_context__.r("[project]/backend/node_modules/mpath/index.js [ssr] (ecmascript)");
const mquery = __turbopack_context__.r("[project]/backend/node_modules/mquery/lib/mquery.js [ssr] (ecmascript)");
...
const removeUnusedArrayFilters = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/update/removeUnusedArrayFilters.js [ssr] (ecmascript)");
...
const sanitizeProjection = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/query/sanitizeProjection.js [ssr] (ecmascript)");
const selectPopulatedFields = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/query/selectPopulatedFields.js [ssr] (ecmascript)");
...
const updateValidators = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/helpers/updateValidators.js [ssr] (ecmascript)");
const util = __turbopack_context__.r("[externals]/util [external] (util, cjs)");
const utils = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/utils.js [ssr] (ecmascript)");
const queryMiddlewareFunctions = __turbopack_context__.r("[project]/backend/node_modules/mongoose/lib/constants.js [ssr] (ecmascript)").queryMiddlewareFunctions;
 ...
 */ Query.prototype.sort = function(arg, options) {
    ...
    if (typeof arg === 'string') {
        const properties = arg.indexOf(' ') === -1 ? [
            arg
        ] : arg.split(' ');
 ...
 */ function _executePostHooks(query, res, error, op) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        query._queryMiddleware.execPost(op || query.op, query, [
            res
        ], opts, (error, res)=>{
            if (error) {
                return reject(error);
...
//# sourceMappingURL=6d019_mongoose_lib_query_4c0ce01e.js.map