...
function AdminPayments() {
    ...
    const loadPayments = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].get("/api/admin/payment/list");
            setPayments(data);
        } catch (err) {
    ...
    const addPayment = async ()=>{
        ...
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$utils$2f$api$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"].post("/api/admin/payment/add", {
                trxID,
                price,
                paymentType
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea6cebf9._.js.map