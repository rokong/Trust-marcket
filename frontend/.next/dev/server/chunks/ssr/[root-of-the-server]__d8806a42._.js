...
function ChatPage() {
    ...
    const socket = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])();
    ...
    /* ---------------- Socket.IO init ---------------- */ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        socket.current = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$socket$2e$io$2d$client__$5b$external$5d$__$28$socket$2e$io$2d$client$2c$__esm_import$29$__["io"])("http://localhost:5000"); // আপনার সার্ভার URL
        socket.current.on("receiveTextMessage", (msg)=>{
    ...
    /* ---------------- Send Reply ---------------- */ const sendReply = ()=>{
        ...
        socket.current.emit("sendTextMessage", msg); // রিয়েল-টাইম পাঠানো
        setReply("");
    };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d8806a42._.js.map